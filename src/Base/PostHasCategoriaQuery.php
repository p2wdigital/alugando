...
use \PostHasCategoria as ChildPostHasCategoria;
 ...
 *
 * @method     \PostQuery|\CategoriaQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PostHasCategoriaQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\PostHasCategoriaQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\PostHasCategoria', $modelAlias = null)
    {
     ...
     *
     * @param \Categoria|ObjectCollection $categoria The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByCategoria($categoria, $comparison = null)
    {
        if ($categoria instanceof \Categoria) {
            ...
            throw new PropelException('filterByCategoria() only accepts arguments of type \Categoria or Collection');
        }
    }
