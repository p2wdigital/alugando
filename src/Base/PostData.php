...
use \PostDataQuery as ChildPostDataQuery;
use \PostQuery as ChildPostQuery;
use \Exception;
use \PDO;
use Map\PostDataTableMap;
...
abstract class PostData implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PostDataTableMap';
    ...
    /**
     * Initializes internal state of Base\PostData object.
     */
    ...
    /**
     * Compares this with another <code>PostData</code> instance.  If
     * <code>obj</code> is an instance of <code>PostData</code>, delegates to
     * <code>equals(PostData)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PostData The current object, for fluid interface
     */
     ...
     * @return $this|\PostData The current object (for fluent API support)
     */
    public function setPostId($v)
    {
        ...
        if ($this->post_id !== $v) {
            $this->post_id = $v;
            $this->modifiedColumns[PostDataTableMap::COL_POST_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[PostDataTableMap::COL_NAME] = true;
        }
    ...
    public function setDhInclusao($v)
    {
        ...
        if ($this->dh_inclusao !== $v) {
            $this->dh_inclusao = $v;
            $this->modifiedColumns[PostDataTableMap::COL_DH_INCLUSAO] = true;
        }
    ...
    public function setDhAlteracao($v)
    {
        ...
        if ($this->dh_alteracao !== $v) {
            $this->dh_alteracao = $v;
            $this->modifiedColumns[PostDataTableMap::COL_DH_ALTERACAO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PostData'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPostDataQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PostData::setDeleted()
     * @see PostData::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPostDataQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PostDataTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PostDataTableMap::COL_DH_ALTERACAO)) {
            $modifiedColumns[':p' . $index++]  = 'dh_alteracao';
        }

        $sql = sprintf(
            'INSERT INTO post_data (%s) VALUES (%s)',
    ...
    {
        $pos = PostDataTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PostData'][$this->hashCode()])) {
            return '*RECURSION*';
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PostDataTableMap::COL_DH_ALTERACAO)) {
            $criteria->add(PostDataTableMap::COL_DH_ALTERACAO, $this->dh_alteracao);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PostData (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PostData Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PostDataTableMap::DEFAULT_STRING_FORMAT);
    }
