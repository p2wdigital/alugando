...
abstract class PageData implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PageDataTableMap';
    ...
    /**
     * Initializes internal state of Base\PageData object.
     */
     ...
     * @return $this|\PageData The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PageData'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PageData (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PageData Clone of current object.
     * @throws PropelException
     */
