...
abstract class Autor implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AutorTableMap';
    ...
    /**
     * Initializes internal state of Base\Autor object.
     */
     ...
     * @return $this|\Autor The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Autor'), 0, $e);
        }
    }
