...
abstract class MenuItem implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MenuItemTableMap';
    ...
    /**
     * Initializes internal state of Base\MenuItem object.
     */
     ...
     * @return $this|\MenuItem The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\MenuItem'), 0, $e);
        }
    }
