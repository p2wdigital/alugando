...
abstract class Page implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PageTableMap';
    ...
    /**
     * Initializes internal state of Base\Page object.
     */
     ...
     * @return $this|\Page The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Page'), 0, $e);
        }
    }
    ...
    public function initPageDatas($overrideExisting = true)
    {
        ...
        $this->collPageDatas->setModel('\PageData');
    }
