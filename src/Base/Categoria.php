...
abstract class Categoria implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CategoriaTableMap';
    ...
    /**
     * Initializes internal state of Base\Categoria object.
     */
     ...
     * @return $this|\Categoria The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Categoria'), 0, $e);
        }
    }
    ...
    public function initPostHasCategorias($overrideExisting = true)
    {
        ...
        $this->collPostHasCategorias->setModel('\PostHasCategoria');
    }
