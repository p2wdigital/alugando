...
class PageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.PageTableMap';
    ...
    {
        $this->addRelation('Autor', '\\Autor', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':autor_id',
    1 => ':id',
        ...
        $this->addRelation('PageData', '\\PageData', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':page_id',
    1 => ':id',
