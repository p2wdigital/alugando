...
use \PostHasCategoria;
use \PostHasCategoriaQuery;
...
class PostHasCategoriaTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.PostHasCategoriaTableMap';
     ...
     */
    const OM_CLASS = '\\PostHasCategoria';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PostHasCategoria';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PostHasCategoria');
        $this->setPackage('');
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Categoria', '\\Categoria', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':categoria_id',
    1 => ':id',
     ...
     * and findPk*() calls.
     *
     * @param \PostHasCategoria $obj A \PostHasCategoria object.
     ...
     *
     * @param mixed $value A \PostHasCategoria object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \PostHasCategoria) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \PostHasCategoria object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PostHasCategoria) { // it's a model object
