...
class PostTableMap extends TableMap
{
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('PostData', '\\PostData', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':post_id',
    1 => ':id',
        ...
        $this->addRelation('PostHasCategoria', '\\PostHasCategoria', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':post_id',
    1 => ':id',
        ...
        $this->addRelation('Categoria', '\\Categoria', RelationMap::MANY_TO_MANY, array(), null, null, 'Categorias');
    } // buildRelations()
