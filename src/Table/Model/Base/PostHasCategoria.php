...
abstract class PostHasCategoria implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Table\\Model\\Map\\PostHasCategoriaTableMap';
    ...
    /**
     * Initializes internal state of Table\Model\Base\PostHasCategoria object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Table\\Model\\PostHasCategoria'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Table\Model\PostHasCategoria
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Table\Model\PostHasCategoria The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Table\Model\PostHasCategoria (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Table\Model\PostHasCategoria Clone of current object.
     * @throws PropelException
     */
