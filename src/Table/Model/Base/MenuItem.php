...
abstract class MenuItem implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Table\\Model\\Map\\MenuItemTableMap';
    ...
    /**
     * Initializes internal state of Table\Model\Base\MenuItem object.
     */
     ...
     *
     * @return $this|MenuItem The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MenuItemTableMap::COL_ID] = true;
        }
    ...
    public function setMenuId($v)
    {
        ...
        if ($this->menu_id !== $v) {
            $this->menu_id = $v;
            $this->modifiedColumns[MenuItemTableMap::COL_MENU_ID] = true;
        }
    ...
    public function setParent($v)
    {
        ...
        if ($this->parent !== $v) {
            $this->parent = $v;
            $this->modifiedColumns[MenuItemTableMap::COL_PARENT] = true;
        }
    ...
    public function setTipo($v)
    {
        ...
        if ($this->tipo !== $v) {
            $this->tipo = $v;
            $this->modifiedColumns[MenuItemTableMap::COL_TIPO] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MenuItemTableMap::COL_ID)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MenuItem'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MenuItem'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Table\Model\MenuItem
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Table\Model\MenuItem The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuItemTableMap::COL_ID)) {
            $criteria->add(MenuItemTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MenuItemTableMap::COL_MENU_ID)) {
    ...
    {
        $criteria = ChildMenuItemQuery::create();
        $criteria->add(MenuItemTableMap::COL_ID, $this->id);
        $criteria->add(MenuItemTableMap::COL_MENU_ID, $this->menu_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Table\Model\MenuItem (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Table\Model\MenuItem Clone of current object.
     * @throws PropelException
     */
