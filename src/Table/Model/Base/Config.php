...
abstract class Config implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Table\\Model\\Map\\ConfigTableMap';
    ...
    /**
     * Initializes internal state of Table\Model\Base\Config object.
     */
     ...
     * @return $this|\Table\Model\Config The current object (for fluent API support)
     */
    ...
    public function setDhInclusao($v)
    {
        ...
        if ($this->dh_inclusao !== $v) {
            $this->dh_inclusao = $v;
            $this->modifiedColumns[ConfigTableMap::COL_DH_INCLUSAO] = true;
        }
    ...
    public function setDhAlteracao($v)
    {
        ...
        if ($this->dh_alteracao !== $v) {
            $this->dh_alteracao = $v;
            $this->modifiedColumns[ConfigTableMap::COL_DH_ALTERACAO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ConfigTableMap::translateFieldName('DhInclusao', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dh_inclusao = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ConfigTableMap::translateFieldName('DhAlteracao', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Table\\Model\\Config'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ConfigTableMap::COL_DH_INCLUSAO)) {
            $modifiedColumns[':p' . $index++]  = 'dh_inclusao';
        }
        if ($this->isColumnModified(ConfigTableMap::COL_DH_ALTERACAO)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Table\Model\Config
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Table\Model\Config The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ConfigTableMap::COL_DH_INCLUSAO)) {
            $criteria->add(ConfigTableMap::COL_DH_INCLUSAO, $this->dh_inclusao);
        }
        if ($this->isColumnModified(ConfigTableMap::COL_DH_ALTERACAO)) {
            $criteria->add(ConfigTableMap::COL_DH_ALTERACAO, $this->dh_alteracao);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Table\Model\Config (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Table\Model\Config Clone of current object.
     * @throws PropelException
     */
