...
abstract class PostData implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Table\\Model\\Map\\PostDataTableMap';
    ...
    /**
     * Initializes internal state of Table\Model\Base\PostData object.
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Table\Model\PostData
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Table\Model\PostData The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Table\Model\PostData (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Table\Model\PostData Clone of current object.
     * @throws PropelException
     */
