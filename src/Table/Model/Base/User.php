...
abstract class User implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Table\\Model\\Map\\UserTableMap';
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Table\Model\User The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Table\Model\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Table\Model\User Clone of current object.
     * @throws PropelException
     */
