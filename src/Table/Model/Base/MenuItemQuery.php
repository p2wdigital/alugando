...
abstract class MenuItemQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Table\Model\Base\MenuItemQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Table\\Model\\MenuItem', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Table\Model\Menu object
     *
     * @param \Table\Model\Menu|ObjectCollection $menu The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($menu instanceof \Table\Model\Menu) {
            return $this
            ...
            throw new PropelException('filterByMenu() only accepts arguments of type \Table\Model\Menu or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Table\Model\MenuQuery A secondary query class using the current class as primary query
     */
    public function useMenuQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinMenu($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Menu', '\Table\Model\MenuQuery');
    }
