 ...
 * @method     ChildPostQuery orderByTipo($order = Criteria::ASC) Order by the tipo column
 ...
 * @method     ChildPostQuery groupByTipo() Group by the tipo column
 ...
 *
 * @method     ChildPostQuery leftJoinMenuItem($relationAlias = null) Adds a LEFT JOIN clause to the query using the MenuItem relation
 * @method     ChildPostQuery rightJoinMenuItem($relationAlias = null) Adds a RIGHT JOIN clause to the query using the MenuItem relation
 * @method     ChildPostQuery innerJoinMenuItem($relationAlias = null) Adds a INNER JOIN clause to the query using the MenuItem relation
 *
 ...
 *
 * @method     \Table\Model\MenuItemQuery|\Table\Model\PostDataQuery|\Table\Model\PostHasCategoriaQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildPost findOneByTipo(int $tipo) Return the first ChildPost filtered by the tipo column
 ...
 * @method     ChildPost requireOneByTipo(int $tipo) Return the first ChildPost filtered by the tipo column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildPost[]|ObjectCollection findByTipo(int $tipo) Return ChildPost objects filtered by the tipo column
...
abstract class PostQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Table\Model\Base\PostQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Table\\Model\\Post', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, titulo, text, tipo, status, url, data, tags, dh_inclusao, dh_alteracao FROM post WHERE id = :p0';
        try {
    ...
    public function filterByTipo($tipo = null, $comparison = null)
    {
        if (is_array($tipo)) {
            $useMinMax = false;
            if (isset($tipo['min'])) {
                $this->addUsingAlias(PostTableMap::COL_TIPO, $tipo['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($tipo['max'])) {
                $this->addUsingAlias(PostTableMap::COL_TIPO, $tipo['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PostTableMap::COL_TIPO, $tipo, $comparison);
    }
    ...
    public function filterByMenuItem($menuItem, $comparison = null)
    {
        if ($menuItem instanceof \Table\Model\MenuItem) {
            return $this
                ->addUsingAlias(PostTableMap::COL_ID, $menuItem->getPostId(), $comparison);
    ...
    /**
     * Filter the query by a related \Table\Model\PostData object
     *
     * @param \Table\Model\PostData|ObjectCollection $postData the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPostQuery The current query, for fluid interface
     */
    ...
    {
        if ($postData instanceof \Table\Model\PostData) {
            return $this
            ...
            throw new PropelException('filterByPostData() only accepts arguments of type \Table\Model\PostData or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Table\Model\PostDataQuery A secondary query class using the current class as primary query
     */
    public function usePostDataQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPostData($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'PostData', '\Table\Model\PostDataQuery');
    }
