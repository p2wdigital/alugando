 ...
 *
 *
 * @method     ChildPostDataQuery orderById($order = Criteria::ASC) Order by the id column
 ...
 * @method     ChildPostDataQuery orderByData($order = Criteria::ASC) Order by the data column
 ...
 *
 * @method     ChildPostDataQuery groupById() Group by the id column
 ...
 * @method     ChildPostDataQuery groupByData() Group by the data column
 ...
 *
 * @method     ChildPostData findOneById(int $id) Return the first ChildPostData filtered by the id column
 ...
 * @method     ChildPostData findOneByData(string $data) Return the first ChildPostData filtered by the data column
 ...
 *
 * @method     ChildPostData requireOneById(int $id) Return the first ChildPostData filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildPostData requireOneByData(string $data) Return the first ChildPostData filtered by the data column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildPostData[]|ObjectCollection findById(int $id) Return ChildPostData objects filtered by the id column
 ...
 * @method     ChildPostData[]|ObjectCollection findByData(string $data) Return ChildPostData objects filtered by the data column
...
abstract class PostDataQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, post_id, name, data, dh_inclusao, dh_alteracao FROM post_data WHERE id = :p0 AND post_id = :p1';
        try {
    ...
    {
        $this->addUsingAlias(PostDataTableMap::COL_ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(PostDataTableMap::COL_POST_ID, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(PostDataTableMap::COL_ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(PostDataTableMap::COL_POST_ID, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(PostDataTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(PostDataTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PostDataTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByData($data = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PostDataTableMap::COL_DATA, $data, $comparison);
    }
    ...
    public function filterByPost($post, $comparison = null)
    {
        if ($post instanceof \Table\Model\Post) {
            ...
            return $this
                ->addUsingAlias(PostDataTableMap::COL_POST_ID, $post->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        if ($postData) {
            $this->addCond('pruneCond0', $this->getAliasedColName(PostDataTableMap::COL_ID), $postData->getId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(PostDataTableMap::COL_POST_ID), $postData->getPostId(), Criteria::NOT_EQUAL);
