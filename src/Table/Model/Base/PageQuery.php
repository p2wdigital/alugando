 ...
 *
 * @method     \Table\Model\AutorQuery|\Table\Model\PageDataQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PageQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Table\Model\Base\PageQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Table\\Model\\Page', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Table\Model\PageData object
     *
     * @param \Table\Model\PageData|ObjectCollection $pageData the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPageQuery The current query, for fluid interface
     */
    ...
    {
        if ($pageData instanceof \Table\Model\PageData) {
            return $this
            ...
            throw new PropelException('filterByPageData() only accepts arguments of type \Table\Model\PageData or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Table\Model\PageDataQuery A secondary query class using the current class as primary query
     */
    public function usePageDataQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPageData($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'PageData', '\Table\Model\PageDataQuery');
    }
