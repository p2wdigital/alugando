...
class CategoriaTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Table.Model.Map.CategoriaTableMap';
     ...
     */
    const OM_CLASS = '\\Table\\Model\\Categoria';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Table.Model.Categoria';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Table\\Model\\Categoria');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Table\Model\Categoria) { // it's a model object
