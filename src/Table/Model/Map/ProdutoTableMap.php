...
use Table\Model\Produto;
use Table\Model\ProdutoQuery;
...
class ProdutoTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Table.Model.Map.ProdutoTableMap';
     ...
     */
    const OM_CLASS = '\\Table\\Model\\Produto';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Table.Model.Produto';
     ...
     */
    const COL_CATEGORIA = 'produto.categoria';

    /**
     * the column name for the nome field
     */
    const COL_NOME = 'produto.nome';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Table\\Model\\Produto');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Table\Model\Produto) { // it's a model object
