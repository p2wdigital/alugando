...
class MenuTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Table.Model.Map.MenuTableMap';
     ...
     */
    const OM_CLASS = '\\Table\\Model\\Menu';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Table.Model.Menu';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Table\\Model\\Menu');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Table\Model\Menu) { // it's a model object
