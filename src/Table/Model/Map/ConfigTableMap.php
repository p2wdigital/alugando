...
use Table\Model\Config;
use Table\Model\ConfigQuery;
...
class ConfigTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Table.Model.Map.ConfigTableMap';
     ...
     */
    const OM_CLASS = '\\Table\\Model\\Config';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Table.Model.Config';
     ...
     */
    const COL_DH_INCLUSAO = 'config.dh_inclusao';

    /**
     * the column name for the dh_alteracao field
     */
    const COL_DH_ALTERACAO = 'config.dh_alteracao';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Key', 'Value', 'DhInclusao', 'DhAlteracao', ),
        self::TYPE_CAMELNAME     => array('id', 'key', 'value', 'dhInclusao', 'dhAlteracao', ),
        self::TYPE_COLNAME       => array(ConfigTableMap::COL_ID, ConfigTableMap::COL_KEY, ConfigTableMap::COL_VALUE, ConfigTableMap::COL_DH_INCLUSAO, ConfigTableMap::COL_DH_ALTERACAO, ),
        self::TYPE_FIELDNAME     => array('id', 'key', 'value', 'dh_inclusao', 'dh_alteracao', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Key' => 1, 'Value' => 2, 'DhInclusao' => 3, 'DhAlteracao' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'key' => 1, 'value' => 2, 'dhInclusao' => 3, 'dhAlteracao' => 4, ),
        self::TYPE_COLNAME       => array(ConfigTableMap::COL_ID => 0, ConfigTableMap::COL_KEY => 1, ConfigTableMap::COL_VALUE => 2, ConfigTableMap::COL_DH_INCLUSAO => 3, ConfigTableMap::COL_DH_ALTERACAO => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'key' => 1, 'value' => 2, 'dh_inclusao' => 3, 'dh_alteracao' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Table\\Model\\Config');
        $this->setPackage('Table.Model');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('key', 'Key', 'VARCHAR', true, 45, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ConfigTableMap::COL_DH_INCLUSAO);
            $criteria->addSelectColumn(ConfigTableMap::COL_DH_ALTERACAO);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Table\Model\Config) { // it's a model object
